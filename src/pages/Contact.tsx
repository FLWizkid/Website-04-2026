        ...
        <div className="grid gap-10 lg:grid-cols-5">
            ...
            <div className="card h-full">
              ...
              <dl className="mt-6 space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  <Mail className="mt-0.5 h-5 w-5 flex-none text-brand-blue" aria-hidden />
                  <div>
                    ...
                    <dd>
                      <a
                        ...
                        className="font-medium text-brand-ink hover:text-brand-blue"
                      >
                ...
                <div className="flex items-start gap-3">
                  <ShieldAlert className="mt-0.5 h-5 w-5 flex-none text-brand-blue" aria-hidden />
                  <div>
                    <dt className="text-xs font-semibold uppercase tracking-widest text-slate-500">
                      Security inquiries
                    </dt>
                ...
                <div className="flex items-start gap-3">
                  <Clock className="mt-0.5 h-5 w-5 flex-none text-brand-blue" aria-hidden />
                  <div>
                    <dt className="text-xs font-semibold uppercase tracking-widest text-slate-500">
                      Response time
                    </dt>
                    <dd className="text-slate-700">1–2 business days</dd>
                  </div>
                </div>
              </dl>
          ...
          <div className="lg:col-span-3">
            <div className="card">
              ...
              <p className="mt-3 rounded-xl bg-brand-gradient-soft px-4 py-3 text-xs text-brand-ink">
              ...
              <form onSubmit={onSubmit} className="mt-6 grid gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-1 block w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-brand-ink focus:border-brand-blue focus:outline-none focus:ring-2 focus:ring-brand-blue/30"
                  >
                ...
                {submitted && (
                  <p
                    role="status"
                    aria-live="polite"
                    className="mt-3 rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-700"
                  >
